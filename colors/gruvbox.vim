...
let s:gb.dark0_hard  = ['#23201c', 234]     " 29-32-33
let s:gb.dark0       = ['#2e2823', 235]     " 40-40-40
let s:gb.dark0_soft  = ['#38312b', 236]     " 50-48-47
let s:gb.dark1       = ['#413932', 237]     " 60-56-54
let s:gb.dark2       = ['#544941', 239]     " 80-73-69
let s:gb.dark3       = ['#685c51', 241]     " 102-92-84
let s:gb.dark4       = ['#7c6f63', 243]     " 124-111-100
let s:gb.dark4_256   = ['#7c6f63', 243]     " 124-111-100

let s:gb.gray_245    = ['#908274', 245]     " 146-131-116
let s:gb.gray_244    = ['#908274', 244]     " 146-131-116

let s:gb.light0_hard = ['#ece6ce', 230]     " 249-245-215
let s:gb.light0      = ['#dcd2b9', 229]     " 253-244-193
let s:gb.light0_soft = ['#c8bda6', 228]     " 242-229-188
let s:gb.light1      = ['#dcd2b9', 223]     " 235-219-178
let s:gb.light2      = ['#c8bda6', 250]     " 213-196-161
let s:gb.light3      = ['#b5aa96', 248]     " 189-174-147
let s:gb.light4      = ['#a39786', 246]     " 168-153-132
let s:gb.light4_256  = ['#a39786', 246]     " 168-153-132

let s:gb.bright_red     = ['#c76e5d', 167]     " 251-73-52
let s:gb.bright_green   = ['#979445', 142]     " 184-187-38
let s:gb.bright_yellow  = ['#c5a65a', 214]     " 250-189-47
let s:gb.bright_blue    = ['#949e92', 109]     " 131-165-152
let s:gb.bright_purple  = ['#c49b9f', 175]     " 211-134-155
let s:gb.bright_aqua    = ['#98ab82', 108]     " 142-192-124
let s:gb.bright_orange  = ['#c2834c', 208]     " 254-128-25

let s:gb.neutral_red    = ['#a24b43', 124]     " 204-36-29
let s:gb.neutral_green  = ['#7e7836', 106]     " 152-151-26
let s:gb.neutral_yellow = ['#ab8949', 172]     " 215-153-33
let s:gb.neutral_blue   = ['#5f7873', 66]      " 69-133-136
let s:gb.neutral_purple = ['#a47884', 132]     " 177-98-134
let s:gb.neutral_aqua   = ['#798c6c', 72]      " 104-157-106
let s:gb.neutral_orange = ['#a6673d', 166]     " 214-93-14
...
if !exists('g:rbpt_colorpairs')
  let g:rbpt_colorpairs =
    \ [
      \ ['blue', '#5f7873'], ['magenta', '#a47884'],
      \ ['red',  '#a24b43'], ['166',     '#a6673d']
    \ ]
endif

let g:rainbow_guifgs = [ '#a6673d', '#a24b43', '#a47884', '#5f7873' ]
